...
LOCAL_SRC_FILES += $(call all-java-files-under, ../orca_changelog/src)

LOCAL_RESOURCE_DIR += $(LOCAL_PATH)/res
LOCAL_RESOURCE_DIR += packages/apps/orca_changelog/res        

LOCAL_AAPT_FLAGS := --auto-add-overlay \
        --extra-packages us.orca.project.changelog
